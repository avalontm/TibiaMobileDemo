...
namespace EmptyKeys.UserInterface.Generated {
    ...
    public sealed class BackpackDictionary : ResourceDictionary {
        
        private static BackpackDictionary singleton = new BackpackDictionary();
        
        public BackpackDictionary() {
            this.InitializeResources();
        }
        
        public static BackpackDictionary Instance {
            get {
                return singleton;
            }
        }
        ...
        private void InitializeResources() {
            // Resource - [BackpackWindowTemplate] ControlTemplate
            Func<UIElement, UIElement> r_0_ctFunc = r_0_ctMethod;
            ControlTemplate r_0_ct = new ControlTemplate(r_0_ctFunc);
            this.Add("BackpackWindowTemplate", r_0_ct);
            ImageManager.Instance.AddImage("Images/ic_close");
            FontManager.Instance.AddFont("Segoe UI", 12F, FontStyle.Bold, "Segoe_UI_9_Bold");
        }
        
        private static UIElement e_8_iptMethod(UIElement parent) {
            // e_9 element
            WrapPanel e_9 = new WrapPanel();
            e_9.Parent = parent;
            e_9.Name = "e_9";
            e_9.IsItemsHost = true;
            e_9.Orientation = Orientation.Horizontal;
            return e_9;
        }
        
        private static UIElement e_8_dtMethod(UIElement parent) {
            // e_10 element
            Border e_10 = new Border();
            e_10.Parent = parent;
            e_10.Name = "e_10";
            e_10.Height = 100F;
            e_10.Width = 100F;
            e_10.Margin = new Thickness(5F, 5F, 5F, 5F);
            e_10.Background = new SolidColorBrush(new ColorW(69, 69, 69, 255));
            e_10.BorderBrush = new SolidColorBrush(new ColorW(69, 69, 69, 255));
            ...
            e_11.Name = "e_11";
            // e_12 element
            ImageButton e_12 = new ImageButton();
            ...
            Binding binding_e_12_Command = new Binding("command");
            e_12.SetBinding(ImageButton.CommandProperty, binding_e_12_Command);
            Binding binding_e_12_CommandParameter = new Binding();
            e_12.SetBinding(ImageButton.CommandParameterProperty, binding_e_12_CommandParameter);
            // e_13 element
            Image e_13 = new Image();
            e_12.Content = e_13;
            e_13.Name = "e_13";
            e_13.Height = 64F;
            e_13.Width = 64F;
            ...
            e_13.Stretch = Stretch.Fill;
            Binding binding_e_13_Source = new Binding("image");
            e_13.SetBinding(Image.SourceProperty, binding_e_13_Source);
            // e_14 element
            TextBlock e_14 = new TextBlock();
            e_11.Children.Add(e_14);
            e_14.Name = "e_14";
            e_14.Margin = new Thickness(0F, 0F, 5F, 5F);
            e_14.HorizontalAlignment = HorizontalAlignment.Right;
            e_14.VerticalAlignment = VerticalAlignment.Bottom;
            e_14.TextAlignment = TextAlignment.Center;
            e_14.FontStyle = FontStyle.Bold;
            Binding binding_e_14_Text = new Binding("count");
        ...
        private static UIElement r_0_ctMethod(UIElement parent) {
            ...
            Grid.SetRow(e_7, 1);
            // e_8 element
            ItemsControl e_8 = new ItemsControl();
            e_7.Children.Add(e_8);
            e_8.Name = "e_8";
            Func<UIElement, UIElement> e_8_iptFunc = e_8_iptMethod;
            ControlTemplate e_8_ipt = new ControlTemplate(e_8_iptFunc);
            e_8.ItemsPanel = e_8_ipt;
            Func<UIElement, UIElement> e_8_dtFunc = e_8_dtMethod;
            e_8.ItemTemplate = new DataTemplate(e_8_dtFunc);
            DragDrop.SetIsDragSource(e_8, true);
            DragDrop.SetIsDropTarget(e_8, true);
            Binding binding_e_8_ItemsSource = new Binding("Items");
            e_8.SetBinding(ItemsControl.ItemsSourceProperty, binding_e_8_ItemsSource);
            // e_15 element
            Grid e_15 = new Grid();
            e_2.Children.Add(e_15);
            e_15.Name = "e_15";
            Grid.SetRow(e_15, 2);
            // e_16 element
            ...
            e_16.Name = "e_16";
            e_16.Margin = new Thickness(5F, 2F, 5F, 2F);
            e_16.HorizontalAlignment = HorizontalAlignment.Center;
            e_16.VerticalAlignment = VerticalAlignment.Center;
            e_16.Foreground = new SolidColorBrush(new ColorW(255, 255, 255, 255));
            Binding binding_e_16_Text = new Binding("Description");
