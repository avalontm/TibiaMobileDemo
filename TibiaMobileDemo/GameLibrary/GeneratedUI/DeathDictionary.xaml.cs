...
namespace EmptyKeys.UserInterface.Generated {
    ...
    public sealed class DeathDictionary : ResourceDictionary {
        
        private static DeathDictionary singleton = new DeathDictionary();
        
        public DeathDictionary() {
            this.InitializeResources();
        }
        
        public static DeathDictionary Instance {
            get {
                return singleton;
            }
        }
        ...
        private static UIElement r_0_ctMethod(UIElement parent) {
            ...
            e_8.Content = "CONTINUAR";
            Binding binding_e_8_Command = new Binding("ContinueCommand");
